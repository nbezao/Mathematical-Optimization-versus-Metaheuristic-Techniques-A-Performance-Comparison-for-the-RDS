#ifndef FLUXO_DEFINITION_H
#define FLUXO_DEFINITION_H
...
class system							// system class definition
{
	public:
		...
		int **D;						// point that points to the matrix that identifies, in the columns of the line k-th of the matrice, which are the lines connected to node k
};
